...
var makeReport=function (questArr,branchName,date,numYes,numNo,result) {
		return {
			questArr:questArr,
...
function send() {
	...
	console.log( trueNumbers*100/questionsArr.length);
	...
	$("#dataRe").empty();
	$("#dataRe").append(date);
	$("#branchTd").append('<input type="text" id="branchName" name="time" class="noBorder">');
	$("#dateTd").append('<input type="text" id="date" name="so3ad" class="noBorder">');

}
//var makeReport=function (questArr,branchName,date,numYes,numNo,result)
function saveRe() {
		reportArr.push(makeReport( questionsArr ,branchName,date,trueNumbers,falseNumbers,(trueNumbers*100/questionsArr.length)));
